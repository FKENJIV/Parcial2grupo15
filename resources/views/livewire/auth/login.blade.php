    ...
    <div class="min-h-screen flex items-center justify-center p-6 bg-white">
        <div class="w-full max-w-md">
            <div class="relative">
                ...
                <div class="relative p-1 rounded-2xl bg-gradient-to-r from-sky-50 to-white">
                    <!-- stronger soft shadow behind the card to separate from background -->
                    <div aria-hidden class="absolute -inset-6 rounded-2xl bg-sky-100 opacity-24 blur-[44px] pointer-events-none z-0"></div>
                        <div aria-hidden class="absolute -inset-2 rounded-2xl bg-black opacity-6 blur-[28px] pointer-events-none z-0"></div>
                        <div class="relative bg-white rounded-2xl z-10 shadow-[0_40px_100px_rgba(2,6,23,0.14)] border-2 border-sky-200 ring-2 ring-sky-50 overflow-hidden transform transition-all hover:-translate-y-1 hover:shadow-[0_80px_160px_rgba(2,6,23,0.18)]">
                        ...
                        <div class="flex flex-col items-center mb-6">
                            ...
                            <h2 class="mt-4 text-2xl font-semibold text-sky-700">Bienvenido</h2>
                            <p class="text-sm text-sky-500 mt-1">Inicia sesión para continuar</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login.store') }}" id="loginForm" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-lg shadow-md">
                                    <input id="email" name="email" type="email" required autofocus autocomplete="email" placeholder="email@example.com"
                                        class="block w-full px-4 py-3 bg-white border-2 border-sky-200 rounded-lg text-sky-800 placeholder-sky-300 shadow focus:outline-none focus:ring-2 focus:ring-sky-200 focus:border-sky-300" />
                                </div>
                            ...
                            <div>
                                <button type="submit" class="w-full inline-flex items-center justify-center rounded-lg bg-sky-500 text-white border border-sky-600 shadow-lg hover:shadow-2xl px-4 py-3 font-semibold transition-transform duration-150">
                                    Iniciar sesión
                                </button>
                            </div>
                        </form>
