<x-layouts.app :title="__('Dashboard')">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <section class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-center h-12 w-12 rounded-xl bg-gradient-to-br from-green-400 to-green-600 shadow-lg">
                    <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-center h-12 w-12 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 shadow-lg">
                    <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-center h-12 w-12 rounded-xl bg-gradient-to-br from-orange-400 to-orange-600 shadow-lg">
                    <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center justify-center h-8 w-8 rounded-full bg-orange-100">
        ...
        <section class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <a href="{{ route('administrar.carga') }}" class="flex items-center gap-3 p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    ...
                    <div>
                        <p class="font-medium text-green-700">Crear Grupo</p>
                        <p class="text-sm text-green-600">Configurar nuevo grupo y horarios</p>
                    </div>
                </a>

                <a href="{{ route('horarios') }}" class="flex items-center gap-3 p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                    ...
                    <div>
                        <p class="font-medium text-blue-700">Ver Horarios</p>
                        <p class="text-sm text-blue-600">Consultar horarios asignados</p>
                    </div>
                </a>

                <a href="{{ route('registro.asistencia') }}" class="flex items-center gap-3 p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
                    ...
                    <div>
                        <p class="font-medium text-orange-700">Registrar Asistencia</p>
                        <p class="text-sm text-orange-600">Marcar asistencia docente</p>
                    </div>
                </a>
            </div>
        </section>
