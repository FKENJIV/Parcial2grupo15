    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <a href="{{ route('admin.subjects.index') }}" class="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                    <div class="flex items-center justify-center h-10 w-10 rounded-lg bg-indigo-100">
                        <svg class="h-5 w-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        <p class="font-medium text-indigo-700">Gestionar Materias</p>
                        <p class="text-sm text-indigo-600">Administrar catálogo de materias</p>
                    </div>
                </a>

                <a href="{{ route('admin.groups.index') }}" class="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                    <div class="flex items-center justify-center h-10 w-10 rounded-lg bg-indigo-100">
                        <svg class="h-5 w-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                        </svg>
                    ...
                    <div>
                        <p class="font-medium text-indigo-700">Gestionar Grupos</p>
                        <p class="text-sm text-indigo-600">Crear y asignar grupos a docentes</p>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.attendance.index') }}" class="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                    <div class="flex items-center justify-center h-10 w-10 rounded-lg bg-indigo-100">
                        <svg class="h-5 w-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    ...
                    <div>
                        <p class="font-medium text-indigo-700">Gestionar Asistencia</p>
                        <p class="text-sm text-indigo-600">Ver y administrar asistencias</p>
                    </div>
                </a>
            </div>
        </section>
